  ...
  return (
    <Popover>
      <Tooltip>
        ...
        <TooltipContent>Configure Athena Pro settings</TooltipContent>
      </Tooltip>
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <h4 className="font-medium flex items-center gap-1.5">
              <Sparkles className="h-4 w-4 text-primary" />
              <span className="text-primary font-medium">Athena Pro</span>
            </h4>
          ...
          <div className="flex flex-col gap-5">
            <SelectorRow
              id="pro-enabled"
              label="Enable Athena Pro"
              description="Use Athena Pro AI credits"
              tooltip="Uses Athena Pro AI credits for the main AI model and Pro modes."
