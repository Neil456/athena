...
export const TitleBar = () => {
  ...
  const _isDyadPro = !!settings?.providerSettings?.auto?.apiKey?.value;
  const _isDyadProEnabled = Boolean(settings?.enableDyadPro);
  ...
  return (
    <>
      <div className="@container z-11 w-full h-11 bg-(--sidebar) absolute top-0 left-0 app-region-drag flex items-center">
        ...
        <img src={logo} alt="Athena Logo" className="w-6 h-6 mr-0.5" />
        <Button
